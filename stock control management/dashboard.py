...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("                                                                                                                             stock control Management System | Developed By Mukthi A And Bhoomika M")
        self.root.config(bg="white")
        #----title----
        self.icon_title=PhotoImage(file="images/logo1.png")
        title=Label(self.root,text="stock control Management System",image=self.icon_title,compound=LEFT,font=("rockwell",40,"bold"),bg="cyan4",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #----clock----
        self.lbl_clock=Label(self.root,text="Welcome to stock control Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("rockwell",15,"italic"),bg="navy",fg="white")
...
#---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_clock.config(text=f"Welcome to stock control Management System\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
